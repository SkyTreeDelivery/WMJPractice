...
import com.homework.wmj.Util.Utils.AdviceUtils;
...
//    }
     ...
     * @throws Throwable
     */
    @Around("execution(* com.homework.wmj.mapper..insert(..))")
...
//        实际上不允许length为0，继续执行会抛出异常
    ...
    @Around("execution(* com.homework.wmj.mapper..update(..))")
...
//        实际上不允许length为0，继续执行会抛出异常
    ...
    @Around("execution(* com.homework.wmj.mapper..updateById(..))")
