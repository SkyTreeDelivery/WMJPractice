package com.homework.wmj.Util.Enum.EnumImp;
...
//    NETWORK_AUTHENTICATION_REQUIRED(511, "Network Authentication Required", "需要进行网络授权");
    ...
    public final String reasonPhraseCN;
    ...
    HttpResponseEnum(int code, String reasonPhraseUS, String reasonPhraseCN) {
        this.code = code;
        this.msg = reasonPhraseUS;
    ...
    public static HttpResponseEnum valueOf(int code) {
        for (HttpResponseEnum httpStatus : values()) {
