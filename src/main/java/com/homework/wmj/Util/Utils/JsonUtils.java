...
import com.homework.wmj.Util.TypeConverter.GeoCodc;
...
public class JsonUtils {
    ...
    public static String wktToGeoJson(String wkt) throws ParseException {
        if(wkt != null){
    ...
    public static Geometry geoJsonToGeom(String geoJson) throws IOException {
        if(geoJson != null){
    ...
    public static Geometry postGisGeomToGeom(org.postgis.Geometry postGisGeom) throws ParseException {
        if(postGisGeom != null){
